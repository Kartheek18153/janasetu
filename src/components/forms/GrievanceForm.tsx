      ...
      {step === 1 && (
        <div className="space-y-6">
          ...
          <div className="flex justify-end pt-2">
            <button onClick={() => setStep(2)} disabled={!canProceed(1)} className="btn-primary px-6">
              Next: Details
            </button>
          </div>
        </div>
      ...
      {step === 2 && (
        <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  onChange={(e) => setForm(prev => ({ ...prev, location: { ...prev.location, city: e.target.value } }))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  onChange={(e) => setForm(prev => ({ ...prev, location: { ...prev.location, district: e.target.value } }))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <input
                  ...
                  onChange={(e) => setForm(prev => ({ ...prev, location: { ...prev.location, state: e.target.value } }))}
                  placeholder="State"
                  className="input"
                />
                <input
                  ...
                  onChange={(e) => setForm(prev => ({ ...prev, location: { ...prev.location, pincode: e.target.value } }))}
                  placeholder="Pincode"
                  maxLength={6}
                  className="input"
                />
          ...
          <div className="flex justify-between pt-2">
            ...
            <button onClick={() => setStep(3)} disabled={!canProceed(2)} className="btn-primary px-6">
              Next: Review
            </button>
          </div>
        </div>
