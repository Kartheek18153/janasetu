...
export default function FileGrievancePage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-secondary-900">File a Grievance</h1>
        <p className="mt-2 text-secondary-500">Submit your complaint and track its progress online</p>
      </div>
      ...
      {submittedTrackingId ? (
        <div className="max-w-lg mx-auto text-center">
          <div className="card p-8">
            ...
            <h2 className="text-xl font-bold text-secondary-900 mb-2">Grievance Submitted!</h2>
            <p className="text-sm text-secondary-500 mb-4">Your grievance has been submitted successfully. Save your tracking ID for future reference.</p>
            <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-6">
              <p className="text-xs text-primary-600 font-medium mb-1">Your Tracking ID</p>
              ...
              {copied && <p className="text-xs text-citizen-teal mt-1">Copied!</p>}
            </div>
